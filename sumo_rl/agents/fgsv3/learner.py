"""FGSv3 SAC learner with separate replay and actor joint-action contexts."""
...
from sumo_rl.agents.fgsv3.rllib_module import FGSV3_ACTOR_QF_PREDS, FGSV3_ACTOR_QF_TWIN_PREDS


class FGSv3SACTorchLearner(SACTorchLearner):
    """Discrete SAC loss for FGSv3 action-token actor and factored critic."""
    ...
    def _compute_loss_for_module_discrete(
        ...
        *,
        ...
        actor_q = fwd_out.get(FGSV3_ACTOR_QF_PREDS, fwd_out[QF_PREDS])
        if config.twin_q:
            actor_q_twin = fwd_out.get(FGSV3_ACTOR_QF_TWIN_PREDS, fwd_out[QF_TWIN_PREDS])
        ...
        self.metrics.log_dict(
            {
                ...
                "fgsv3_actor_q_mean": torch.mean(actor_q),
