...
def test_parse_statistic_output_reads_vehicle_and_trip_sections(tmp_path: Path):
    ...
    statistic_xml.write_text(
        """<statistics>
  <performance
      clockBegin="1" clockEnd="2" clockDuration="3" traciDuration="0.5" realTimeFactor="4.0" vehicleUpdatesPerSecond="2000"
  />
  ...
  <vehicleTripStatistics
      count="80" speed="9.5" duration="120" waitingTime="50" timeLoss="40" departDelay="5" departDelayWaiting="30"
      totalTravelTime="9600" totalDepartDelay="450"
  />
</statistics>""",
        encoding="utf-8",
    )
...
def test_load_statistic_output_maps_public_metric_names(tmp_path: Path):
    ...
    statistic_xml.write_text(
        """<statistics>
  <performance
      clockDuration="12" traciDuration="1.5" realTimeFactor="6.0" vehicleUpdatesPerSecond="2500"
  />
  <vehicles loaded="40" inserted="35" running="5" waiting="2" />
  <vehicleTripStatistics
      speed="8.0" duration="100" waitingTime="30" timeLoss="20" departDelay="4" departDelayWaiting="10"
      totalTravelTime="3500" totalDepartDelay="140"
  />
</statistics>""",
        encoding="utf-8",
    )
